  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-primary-lg': '0 0 30px rgba(14, 165, 233, 0.6)',
        'glow-secondary': '0 0 20px rgba(217, 119, 6, 0.5)',
        'glow-secondary-lg': '0 0 30px rgba(217, 119, 6, 0.6)',
        'glow-accent': '0 0 20px rgba(147, 51, 234, 0.5)',
        'glow-accent-lg': '0 0 30px rgba(147, 51, 234, 0.6)',
        'glow-error': '0 0 20px rgba(239, 68, 68, 0.5)',
        'glow-error-lg': '0 0 30px rgba(239, 68, 68, 0.6)',
        // Inner shadows
