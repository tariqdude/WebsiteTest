...
export const siteConfig: SiteConfig = {
  hero: {
    ...
    description:
      'Empower your organization with cutting-edge technology solutions designed for Fortune 500 companies. Scale faster, innovate smarter, and stay ahead of the competition.',
    primaryCTA: {
  ...
  business: {
    ...
    description:
      'Leading provider of innovative business solutions that drive growth, efficiency, and success across industries.',
    founded: '2020',
  ...
  seo: {
    ...
    description:
      'Transform your business with our innovative solutions. Expert consulting, cutting-edge technology, and proven strategies for sustainable growth.',
    keywords: [
      'business consulting',
