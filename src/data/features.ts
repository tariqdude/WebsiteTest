...
export const businessFeatures: BusinessFeature[] = [
  {
    ...
    description: "Transform your business strategy with expert guidance and data-driven insights that deliver measurable results.",
    longDescription: "Our strategic consulting services help businesses navigate complex challenges, identify growth opportunities, and implement sustainable solutions. We work closely with your leadership team to develop comprehensive strategies that align with your goals and market dynamics.",
    benefits: [
...

  {
    ...
    description: "Modernize your business processes with cutting-edge technology solutions that boost efficiency and productivity.",
    longDescription: "Our digital transformation services help businesses leverage technology to streamline operations, improve customer experience, and drive innovation. We provide end-to-end solutions from strategy to implementation.",
    benefits: [
...

  {
    ...
    description: "Streamline your operations with lean methodologies and smart automation to maximize efficiency and reduce costs.",
    benefits: [
...

  {
    ...
    description: "Protect your business with comprehensive security solutions including threat detection, compliance, and risk management.",
    benefits: [
...

  {
    ...
    description: "Empower your team with comprehensive training programs designed to enhance skills and drive business growth.",
    benefits: [
...
export const pricingTiers = {
  ...
  standard: {
    ...
    color: "blue",
    features: ["Priority support", "Advanced features", "Phone support", "Training included"]
  },
  premium: {
    name: "Premium",
    description: "For established enterprises",
    color: "purple",
    features: ["24/7 support", "Premium features", "Dedicated manager", "Custom integrations"]
  },
  enterprise: {
    name: "Enterprise",
    description: "Custom solutions for large organizations",
    color: "gold",
    features: ["White-glove service", "Custom development", "SLA guarantee", "On-site support"]
  }
};
