...
export const teamMembers: TeamMember[] = [
  {
    ...
    achievements: [
      'Published 10+ ML research papers',
      'Led analytics for Fortune 100 companies',
    ],
    featured: false,
  },
  {
...
export const companyValues: CompanyValue[] = [
  {
    ...
    title: 'Excellence',
    description:
      'We strive for excellence in everything we do, from client service to technical implementation. Our commitment to quality ensures that every project exceeds expectations.',
    icon: 'star',
    examples: [
  ...
  },
  {
    ...
    title: 'Innovation',
    description:
      'We embrace cutting-edge technologies and creative solutions to solve complex business challenges. Innovation drives our approach to problem-solving.',
    icon: 'lightbulb',
    examples: [
  ...
  },
  {
    ...
    title: 'Integrity',
    description:
      'Honesty, transparency, and ethical business practices are the foundation of our relationships with clients, partners, and team members.',
    icon: 'shield',
    examples: [
  ...
  },
  {
    ...
    title: 'Collaboration',
    description:
      'We believe the best results come from working together. We partner closely with our clients and foster teamwork within our organization.',
    icon: 'users',
    examples: [
  ...
  },
  {
    ...
    title: 'Impact',
    description:
      "We measure our success by the positive impact we create for our clients' businesses and the communities we serve.",
    icon: 'trending-up',
    examples: [
  ...
  },
  {
    ...
    title: 'Growth',
    description:
      "We are committed to continuous learning and development, both for our team members and our clients' organizations.",
    icon: 'arrow-up',
    examples: [
...
export const companyMilestones: CompanyMilestone[] = [
  {
    ...
    description:
      'Opened dedicated AI research and development center to advance machine learning solutions for enterprise clients.',
    impact:
      'Positioned as industry leader in AI consulting with 15 new ML-powered solutions launched.',
  },
  {
    year: 2023,
    title: '500+ Client Milestone',
    description:
      'Reached milestone of serving over 500 satisfied clients across 25+ industries worldwide.',
    impact:
      'Established global presence with consistent 98% client satisfaction rating.',
  },
  {
    year: 2022,
    title: 'Cybersecurity Excellence Award',
    description:
      "Recognized as 'Cybersecurity Consulting Firm of the Year' by industry association.",
    impact:
      'Strengthened reputation as trusted security partner for Fortune 500 companies.',
  },
  {
    year: 2021,
    title: 'Cloud Migration Expertise',
    description:
      'Became certified partner with all major cloud providers (AWS, Azure, Google Cloud).',
    impact:
      'Successfully migrated 1000+ applications to cloud with zero downtime record.',
  },
  {
    year: 2020,
    title: 'Remote Work Transformation',
    description:
      'Led industry in remote work solutions during global pandemic, helping 200+ companies adapt.',
    impact:
      "Maintained 100% project delivery rate while supporting clients' remote transformation.",
  },
  {
    year: 2019,
    title: 'International Expansion',
    description:
      'Expanded operations to Europe and Asia with offices in London and Singapore.',
    impact:
      'Enabled 24/7 global support and local expertise for international clients.',
  },
  {
    year: 2018,
    title: 'Digital Transformation Leader',
    description:
      'Recognized as top digital transformation consultant by major industry publication.',
    impact:
      'Led 100+ successful digital transformation projects with average 40% efficiency gains.',
  },
  {
    year: 2015,
    title: 'Company Founded',
    description:
      'Enterprise Solutions Pro founded with mission to help businesses leverage technology for growth.',
    impact:
      'Started with vision to democratize enterprise-grade technology solutions for all businesses.',
  },
];
...
export const companyOverview = {
  ...
  vision:
    "To be the world's most trusted partner for digital transformation and business innovation.",
  approach:
    'We combine deep industry expertise with cutting-edge technology to deliver solutions that create lasting value for our clients.',
};
