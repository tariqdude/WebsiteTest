export const siteConfig = {
  ...
  hero: {
    ...
    description: "We help businesses scale and thrive in the digital age with cutting-edge technology and proven strategies.",
    primaryCta: {
...
export const features = [
  {
    ...
    description: "Get real-time insights with our advanced AI analytics platform that helps you make data-driven decisions.",
    icon: "BarChart3",
  ...
  },
  {
    ...
    description: "Seamlessly integrate with leading cloud platforms for scalable and secure business operations.",
    icon: "Cloud",
  ...
  },
  {
    id: 3,
    title: "24/7 Support",
    description: "Round-the-clock expert support to ensure your business operations run smoothly without interruption.",
    icon: "Headphones",
  ...
  },
  {
    ...
    icon: "Settings",
    benefits: ["Personalized approach", "Industry expertise", "Flexible pricing"]
  },
  {
    id: 5,
  ...
  },
  {
    id: 6,
    title: "Mobile Ready",
    description: "Fully responsive solutions that work perfectly across all devices and platforms.",
    icon: "Smartphone",
...
export const testimonials = [
  {
    ...
    content: "BusinessPro transformed our operations completely. We saw a 300% increase in efficiency within the first quarter.",
    rating: 5,
  ...
  },
  {
    ...
    role: "CTO, StartupXYZ",
    company: "StartupXYZ",
    content: "The AI-powered analytics gave us insights we never had before. Game-changing for our decision-making process.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Outstanding support and incredibly robust platform. Our productivity has increased by 250% since implementation.",
    rating: 5,
...
export const services = [
  {
    ...
    features: ["Process automation", "System integration", "Staff training", "Ongoing support"]
  },
  {
    id: 2,
    ...
    features: ["Custom AI models", "Data analysis", "Predictive insights", "Performance monitoring"]
  },
  {
    id: 3,
