...
const SimpleDemo = ({ title = "React Demo", type = "counter" }) => {
  ...
  if (type === "counter") {
    return (
      <div className="card p-6 max-w-sm mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg">
  ...
  if (type === "message") {
    return (
      <div className="card p-6 max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        <h3 className="text-xl font-bold text-center mb-4 text-gray-900 dark:text-white">
          {title}
        </h3>
